...
// -------------------------------------------------------------
// 01 — TERMINAL BLOCK
// Monogram = lime square with "JTM_" cursor prompt. Pure system feel.
// -------------------------------------------------------------
// JTM_ stacked: "JTM" on top, blinking underscore below.
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="48" y="52" textAnchor="middle"
        ...
        fontSize="34" fontWeight="700" fill={INK} letterSpacing="-0.02em">JTM</text>
      <rect x="34" y="66" width="28" height="6" fill={INK}>
...
// JTM_ inline: rendered as a single text element so the underscore sits
// directly under the M (terminal-prompt feel). Underscore blinks.
function MarkTerminalInline({ size = 96 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="2" y="2" width="92" height="92" rx="14" fill={LIME} />
      <text x="48" y="60" textAnchor="middle"
        fontFamily="Geist Mono, ui-monospace, monospace"
        fontSize="26" fontWeight="700" fill={INK} letterSpacing="-0.02em">JTM<tspan>_<animate attributeName="opacity" values="1;1;0;0" dur="1.1s" repeatCount="indefinite" /></tspan></text>
    </svg>
  );
}
...
function WordmarkTerminalInline({ markSize = 56 } = {}) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
      <MarkTerminalInline size={markSize} />
      <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
        <div style={{ fontFamily: "Geist Mono, monospace", fontSize: 22, fontWeight: 700, color: FOG, letterSpacing: "-0.01em" }}>
          JTM<span style={{ color: LIME }}>_</span>
        </div>
...
function LockupTerminalInline() {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 18 }}>
      <MarkTerminalInline size={88} />
      <div style={{ fontFamily: "Geist Mono, monospace", fontSize: 22, fontWeight: 700, color: FOG, letterSpacing: "-0.01em" }}>
        JTM<span style={{ color: LIME }}>_</span>CONSULTING
      </div>
      <div style={{ fontFamily: "Geist Mono, monospace", fontSize: 10, fontWeight: 500, color: DIM, letterSpacing: "0.24em" }}>
...
function FaviconTerminal() {
  // Stacked JTM_ — readable down to 16px because "JTM" stays one line.
  return (
    <svg width="64" height="64" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="16" y="17" textAnchor="middle"
        fontFamily="Geist Mono, monospace" fontSize="11" fontWeight="700" fill={INK} letterSpacing="-0.02em">JTM</text>
      <rect x="11" y="22" width="10" height="2.5" fill={INK} />
    </svg>
  );
}
function FaviconTerminalInline() {
  // JTM_ on a single line. Underscore is the cursor.
  return (
    <svg width="64" height="64" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
      <rect width="32" height="32" rx="6" fill={LIME} />
      <text x="16" y="21" textAnchor="middle" fontFamily="Geist Mono, monospace" fontSize="11" fontWeight="700" fill={INK} letterSpacing="-0.04em">JTM_</text>
    </svg>
  );
}
...
// -------------------------------------------------------------
const directions = [
  { id: "01-terminal", title: "01 / Terminal — JTM_ stacked", subtitle: "JTM monogram with blinking cursor underline. Reads at every size.", Mark: MarkTerminal, Word: WordmarkTerminal, Lock: LockupTerminal, Fav: FaviconTerminal },
  { id: "01b-terminal-inline", title: "01b / Terminal — JTM_ inline", subtitle: "Single-line JTM_ with trailing cursor block. Denser, more wordmark-like.", Mark: MarkTerminalInline, Word: WordmarkTerminalInline, Lock: LockupTerminalInline, Fav: FaviconTerminalInline },
